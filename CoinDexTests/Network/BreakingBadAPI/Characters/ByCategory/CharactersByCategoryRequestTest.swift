...
class CharactersByCategoryRequestTest: XCTestCase {

    var request: CharactersByCategoryRequest!
    var jsonData: Data!

    override func setUp() {
        super.setUp()
        
        self.request = CharactersByCategoryRequest(baseURL: "http://www.test.com",
    ...
    func testCharactersByCategoryRequestTest_01() {
    ...
    func testCharactersByCategoryRequestTest_02() {
        do {
