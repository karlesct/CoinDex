...
/// Get current price of toekens (using contract addresses) for a given platform in any other currency that you need
struct SimpleTokenPriceRequest: DataRequest {
